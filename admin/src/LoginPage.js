//admin/src/LoginPage.js
//This is the login page. It is a copy of the default login page using the original source code.
                ...
                <div style={{ ...styles.main, backgroundColor: primary1Color }}>
                    <Card style={styles.card}>
                        <div style={styles.avatar}>
                            <Avatar src={ProjectLogo2} size={150} style={{border: 0, objectFit: 'cover'}}/>
                        </div>
                        <form onSubmit={handleSubmit(this.login)}>
                            <div style={styles.form}>
                                <p align="center">ChalkTalk Presentations</p>
